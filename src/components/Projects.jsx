...
export default function Projects() {
  ...
  const myProjects = [
    {name: 'Etune', badges: ["React", "Express"], img: 'https://github.com/nyozov/etune/raw/master/src/assets/wide-view.png?raw=true', url:'https://github.com/nyozov/etune'},
    {name: 'Therapify', badges: ["React", "Express"], img: therapifyImg, url:'https://github.com/habibcodes/therapify'},
    {name: 'Weather App', badges: ["React"], img:'https://github.com/nyozov/weather-app/raw/master/public/weather-app-gif.gif?raw=true'},
    {name: 'Scheduler', badges: ["React"], img:'https://github.com/nyozov/scheduler/raw/master/docs/creating-interview.png?raw=true'},
    {name: 'Url Shortener', badges: ["Express", "Vanilla JS"], img:'https://github.com/nyozov/tinyapp/raw/master/docs/newurl-page.png?raw=true'},
    {name: 'Tweeter', badges: ["JQuery"], img:'https://github.com/nyozov/tweeter/raw/master/docs/tweet_widescreen.png?raw=true'},
    ...
    return (
        <div className="absolute dark:bg-gray-900 bg-gray-200 w-full h-screen">
            <motion.div className='dark:bg-gray-900 bg-gray-200'
                ...
                <div>
                        <h4 className="text-2xl font-bold leading-tight dark:text-gray-200 text-gray-800">Recent Projects</h4>
                ...
                {/* Page title ends */}
                <div className="container dark:bg-gray-900 mx-auto px-6">
                    ...
                    <div className="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 pt-6 gap-8">
                      ...
                      {myProjects.map(project => {
                        ...
                        <div className="max-w-sm bg-white p-2 m-2 rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <img className="h-52 w-96 object-cover rounded-t-lg" src={project.img} alt="" />
