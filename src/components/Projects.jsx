    ...
    <div className="py-12 dark:bg-gray-900 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          <h1 className="text-base text-indigo-600 font-semibold tracking-wide uppercase">Recent Projects</h1>
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-8">
                                    <div>
                                        ...
                                        <div className="py-2 px-4 w-full flex justify-between bg-indigo-700">
                                            <p className="text-sm text-white font-semibold tracking-wide">Etune</p>
                                            <p className="text-sm text-white font-semibold tracking-wide">React, Express</p>
                                    ...
                                    <div>
                                        ...
                                        <div className="py-2 px-4 w-full flex justify-between bg-indigo-700">
                                            <p className="text-sm text-white font-semibold tracking-wide">Therapify</p>
                                            <p className="text-sm text-white font-semibold tracking-wide">React Express</p>
                                        </div>
                                        <div className="bg-white px-3  lg:px-6 py-4 rounded-bl-3xl rounded-br-3xl">
        ...
        <div className="mt-10">
        <div className="lg:text-center">
          <h1 className="text-base text-indigo-600 font-semibold tracking-wide uppercase">Skills</h1>
            ...
            {features.map((feature) => (
              <div key={feature.name} className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium dark:text-white text-gray-900">{feature.name}</p>
                </dt>
